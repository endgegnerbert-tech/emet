...
// ponytail: remove COLLECTOR_* aliases after unified plan lands.
export const COLLECTOR_SESSION_TTL = SESSION_TTL;
export const COLLECTOR_MAX_SESSIONS = MAX_SESSIONS;
export const COLLECTOR_MAX_TURNS_DEFAULT = DEFAULT_MAX_TURNS;
