...
export function buildResearchGuardrails(query = "", options = {}) {
  ...
  flags.primary_source_required = flagPattern(/\b(primary source|official advisory|vendor advisory|publisher|doi|arxiv|pubmed|paper|study|clinical guideline|regulator|standard|rfc|specification)\b/i, q);
