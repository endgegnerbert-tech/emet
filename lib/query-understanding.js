...
export function mergeQueryUnderstandingPrediction(query = "", predicted = null, options = {}) {
  ...
  if (!predicted) {
    return {
      ...
      decisionSource: "heuristic",
      decisionReason: "tiny_router_unavailable_or_low_confidence",
  ...
  const final = {
    ...
    decisionSource: predicted.acceptedAny ? "tiny_router" : "heuristic",
  };
  ...
  return {
    ...
    decisionSource: predicted.acceptedAny ? "tiny_router" : "heuristic",
    decisionReason: predicted.acceptedAny ? "tiny_router_features" : "abstained_to_heuristic",
